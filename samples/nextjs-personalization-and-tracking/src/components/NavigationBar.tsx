...
/**
 * The main layout (columns) of the page.
 ...
 */
const NavigationBar = (props: ComponentProps): JSX.Element => {
  ...
  // and projects them into the left navigation column for the page
  const sections = getChildPlaceholder(
    props.rendering,
    'jssnextpersonalizationweb-layout-with-navigation'
  )
    ...
    .map((section) => ({
      ...
      children: getChildPlaceholder(getRendering(section), 'jssnextpersonalizationweb-section')
  ...
  return (
    <div className="row">
      <div className="col-sm-8 col-lg-10">
        <Placeholder
          name="jssnextpersonalizationweb-layout-with-navigation"
