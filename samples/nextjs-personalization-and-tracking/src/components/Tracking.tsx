...
import { ComponentWithContextProps, SpecimenFields } from 'lib/component-props';
import Specimen from './Specimen';

type TrackingProps = ComponentWithContextProps & SpecimenFields;

/**
 * Demonstrates analytics tracking patterns (xDB)
 */
class Tracking extends React.Component<TrackingProps> {
  ...
  render() {
    return (
      <Specimen {...this.props} e2eId="tracking">
        <div>
...
export default withSitecoreContext()(Tracking);
