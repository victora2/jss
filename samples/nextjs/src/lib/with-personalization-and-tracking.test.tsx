...
describe('withCurrentPageTracking', () => {
  ...
  beforeEach(() => {
    ...
    TestComponentWithContext = withCurrentPageTracking(testComponentStub, trackingService);
  });
...
describe('withNotFoundPageTracking', () => {
  ...
  beforeEach(() => {
    ...
    testComponentStub = stub().callsFake(() => <div />);
    TestComponentWithContext = withNotFoundPageTracking(testComponentStub, trackingService);
  });
